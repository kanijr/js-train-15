...
function calculateCircleArea(radius) {
  ...
  return typeof radius === "number" ? Math.PI * radius ** 2 : null;
}
...
function calculateVolumeCylinder(radius, height) {
  ...
  return typeof radius === "number" && typeof height === "number"
    ? Math.ceil(Math.PI * Math.pow(radius, 2) * height)
    : console.log("Помилка: аргументи мають бути числами") || null;
}
...
function sumPositiveNumbers(numbers) {
  ...
  return typeof numbers === "object"
    ? numbers.reduce(
        (res, value) => (Math.sign(value) === 1 ? res + value : res),
        0
      )
    : console.log("Помилка: аргумент має бути масивом чисел") || null;
}
...
function getFractionalPart(num) {
  ...
  return typeof num === "number"
    ? Math.fround(num - Math.trunc(num))
    : console.log("Помилка: аргумент має бути числом") || null;
}
...
function compareAndRound(num1, num2) {
  ...
  return typeof num1 === "number" && typeof num2 === "number"
    ...
    : console.log("Помилка: обидва аргументи мають бути числами") || null;
}
...
function estimateInvestment(principal, interestRate, years) {
  ...
  return typeof principal === "number" &&
    typeof interestRate === "number" &&
    typeof years === "number"
    ? Math.round(principal * Math.pow(1 + interestRate, years))
    : console.log("Помилка: усі аргументи мають бути числами") || null;
}
...
function isTotalPriceExceedsMaxPrice(products, maxPrice) {
  ...
  return typeof products === "object" && typeof maxPrice === "number"
    ? Math.fround(products.reduce((res, value) => res + value.price, 0)) >
        maxPrice
    : console.log("Помилка: аргументи мають бути списком та числом") || null;
}
